...
//        this.height = height;
//
//        if(age > 100) System.out.println("Warning : as per the data, system analyse you are overweight due to that you can suffer from a lot of health issues get your health check first, or loose you overall body weight and body fat with our system.");
//
...
public class Client {
    ...
    public void setClientData(String name, int age, float weight, double height) {
        ...
        if (weight > 100) {
            System.out.println("⚠️ Warning: According to the data, you might be overweight and could suffer health issues. Please get a health check or reduce your body weight/fat.");
        }
